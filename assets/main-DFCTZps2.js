import{a as L}from"./vendor-CR7N1gwd.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))s(t);new MutationObserver(t=>{for(const r of t)if(r.type==="childList")for(const d of r.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&s(d)}).observe(document,{childList:!0,subtree:!0});function i(t){const r={};return t.integrity&&(r.integrity=t.integrity),t.referrerPolicy&&(r.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?r.credentials="include":t.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(t){if(t.ep)return;t.ep=!0;const r=i(t);fetch(t.href,r)}})();const x="https://your-energy.b.goit.study/api/",S=async(c,o)=>{try{const i=`${x}${c}`;return(await L.get(i,{params:o})).data}catch(i){throw i}};let a;function v(){window.matchMedia("(min-width: 768px)").matches&&window.matchMedia("(max-width: 1439px)").matches?a=1:window.matchMedia("(min-width: 1439px)").matches?a=2:a=0}v();addEventListener("resize",v);const b=document.querySelector(".exercises-list"),P=(c,o)=>{const i=c.results.map(s=>`
...
//# sourceMappingURL=main-DFCTZps2.js.map
