import"./assets/main-SQSFrRDD.js";import"./assets/vendor-CR7N1gwd.js";document.addEventListener("DOMContentLoaded",function(){const m=document.getElementById("no-favorites"),s=document.getElementById("exercise-modal"),g=document.getElementById("modal-title"),y=document.getElementById("modal-details"),b=document.querySelector(".close-btn"),c=document.querySelector(".pagination"),r=document.querySelector("#favorites-container"),d=6;let i=JSON.parse(localStorage.getItem("favorites"))||[],a=1;function u(t=1){if(r.innerHTML="",i.length===0)m.style.display="block";else{m.style.display="none";const e=(t-1)*d,n=e+d;i.slice(e,n).forEach(o=>E(o)),L(i.length,t)}}function E(t){const e=document.createElement("li");e.className="exercises-cards-item",e.innerHTML=`
